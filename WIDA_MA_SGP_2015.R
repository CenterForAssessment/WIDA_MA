#########################################################################################
###
### Script for calculating SGPs for 2014-2015 for WIDA/ACCESS
###
#########################################################################################
...
load("Data/WIDA_MA_Data_LONG_2015.Rdata")


### Create config for percentiles and 1 projections

READING_2015.config <- list(
        READING.2015 = list(
                sgp.content.areas=rep('READING', 4),
                sgp.projection.content.areas=rep('READING', 3),
                sgp.projection.baseline.content.areas=rep('READING', 2),
                sgp.panel.years=c('2012', '2013', '2014', '2015'),
                sgp.projection.panel.years=c('2013', '2014', '2015'),
                sgp.projection.baseline.panel.years=c('2014', '2015'),
                ...
                sgp.projection.grade.sequences=list('0', c('0', '1'), c('1', '2', '3'), c('2', '3', '4'), c('3', '4', '5'), c('4', '5', '6'), c('5', '6', '7'), c('6', '7', '8'), c('7', '8', '9'), c('8', '9', '10'), c('9', '10', '11'), c('10', '11', '12')),
