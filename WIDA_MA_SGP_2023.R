...
tmp.data[YEAR=="2023", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_0_YEAR_PROJ_YEAR_1:=SGPstateData[['WIDA']][['SGP_Configuration']][['ss_to_pl_function']][['value']](GRADE, SCALE_SCORE_SGP_TARGET_BASELINE_0_YEAR_PROJ_YEAR_1)]

### Select PROFICIENCY_TARGETS based upon YEARS_IN_MASS
tmp.data[YEAR=="2023" & YEARS_IN_MA==0, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_5_YEAR_PROJ_YEAR_1]
tmp.data[YEAR=="2023" & YEARS_IN_MA==1, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_4_YEAR_PROJ_YEAR_1]
tmp.data[YEAR=="2023" & YEARS_IN_MA==2, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_3_YEAR_PROJ_YEAR_1]
tmp.data[YEAR=="2023" & YEARS_IN_MA==3, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_2_YEAR_PROJ_YEAR_1]
tmp.data[YEAR=="2023" & YEARS_IN_MA==4, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_1_YEAR_PROJ_YEAR_1]
tmp.data[YEAR=="2023" & YEARS_IN_MA>=5, ACCOUNTABILITY_PROFICIENCY_LEVEL_TARGET:=PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_0_YEAR_PROJ_YEAR_1]

### Overwrite @Data with new tmp.data
