...
setnames(WIDA_MA_Data_LONG, c("ID", "LAST_NAME", "FIRST_NAME", "DOB", "GRADE", "SS_LEVEL", "SCALE_SCORE", "GRADESPAN", "YEAR", "TEST_MODE"))

WIDA_MA_Data_LONG <- subset(WIDA_MA_Data_LONG, select=c("YEAR", "ID", "GRADE", "SCALE_SCORE", "TEST_MODE"))
...
setcolorder(WIDA_MA_Data_LONG, c(6,7,1,2,3,4,5))
